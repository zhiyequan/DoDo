...
public class NormalActivity extends PreferenceActivity implements OnPreferenceChangeListener,
		OnPreferenceClickListener {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
        setContentView(R.layout.set_head);
		addPreferencesFromResource(R.xml.normal);
        ...
        ((TextView) findViewById(R.id.settitletext)).setText("通用");
    ...
    public boolean onPreferenceClick(Preference preference) {  
        ...
        {   
    		Dialog alertDialog = new AlertDialog.Builder(NormalActivity.this, AlertDialog.THEME_HOLO_LIGHT).
                    setTitle("����"). 
                    setMessage("ȷ��Ҫ�ָ�Ĭ��������?"). 
                    ...
                    setPositiveButton("ȷ��", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(NormalActivity.this.getApplicationContext());
