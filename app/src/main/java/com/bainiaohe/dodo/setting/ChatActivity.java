...
public class ChatActivity extends PreferenceActivity implements OnPreferenceChangeListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.settitletext)).setText("聊天");
    ...
    public boolean onPreferenceClick(Preference preference) {  
        ...
        {   
    		Dialog alertDialog = new AlertDialog.Builder(ChatActivity.this, AlertDialog.THEME_HOLO_LIGHT).
                    setTitle("����"). 
                    setMessage("ȷ��Ҫ�ָ�Ĭ��������?"). 
                    ...
                    setPositiveButton("ȷ��", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(ChatActivity.this.getApplicationContext());
